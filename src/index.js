...
ipcMain.on('call-them', async (event, allThem) => {
  ...
  try {
    ...
    // login
    await driver.findElement(By.xpath('/html/body/main/section[1]/div/div/form/div[1]/div[1]/div/div/input')).sendKeys(inputUser)
    await driver.findElement(By.xpath('/html/body/main/section[1]/div/div/form/div[1]/div[2]/div/div/input')).sendKeys(inputPassword,Key.ENTER)
    ...
    if(selectValue !== "emplois"){
      await driver.findElement(By.xpath('/html/body/div[4]/header/div/div/div/div[1]/input')).sendKeys(inputSearch,Key.ENTER)
    } else {
      await driver.findElement(By.css('[id^="jobs-search-box-keyword-id-"]')).sendKeys(inputSearch,Key.ENTER)
    }
